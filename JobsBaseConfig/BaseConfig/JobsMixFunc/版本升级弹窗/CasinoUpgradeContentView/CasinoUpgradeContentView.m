...
+(CGSize)viewSizeWithModel:(id _Nullable)model{
    return CGSizeMake(KWidth(290), KWidth(133));
}
#pragma mark —— lazyLoad
-(UILabel *)titleLab{
    if (!_titleLab) {
        _titleLab = UILabel.new;
        _titleLab.font = [UIFont systemFontOfSize:KWidth(14) weight:UIFontWeightMedium];
...
-(UIButton *)cancelBtn{
    if (!_cancelBtn) {
        ...
        [_cancelBtn titleFont:[UIFont systemFontOfSize:KWidth(14) weight:UIControlStateNormal]];
...
-(UIButton *)sureBtn{
    if (!_sureBtn) {
        ...
        [_sureBtn titleFont:[UIFont systemFontOfSize:KWidth(14) weight:UIControlStateNormal]];
