...
//    [self registerClass:CasinoNoAddBankCardCVCell.class
//        forCellWithReuseIdentifier:reuseIdentifier(CasinoNoAddBankCardCVCell)];
//    [self registerClass:CasinoHasAddedBankCardCVCell.class
//        forCellWithReuseIdentifier:reuseIdentifier(CasinoHasAddedBankCardCVCell)];
//    [self registerClass:CasinoAgencyRecommendCVCell.class
//        forCellWithReuseIdentifier:reuseIdentifier(CasinoAgencyRecommendCVCell)];
//    [self registerClass:CasinoAgencyRecommendTopCVCell.class
//        forCellWithReuseIdentifier:reuseIdentifier(CasinoAgencyRecommendTopCVCell)];
}
