...
+(URLManagerModel *)downloadStationGetFileServerUrlGET{
    return [NSObject url:@"/downloadStation/getFileServerUrl"
                funcName:NSStringFromSelector(_cmd)];
}
/// 获取iOS最新下载链接
...
+(URLManagerModel *)downloadStationGetLogImageUrlAppGET{
    return [NSObject url:@"/downloadStation/getLogImageUrlApp"
                funcName:NSStringFromSelector(_cmd)];
}
/// 获取PC端logo
+(URLManagerModel *)downloadStationGetLogImageUrlPcGET{
    return [NSObject url:@"​/downloadStation​/getLogImageUrlPc"
                funcName:NSStringFromSelector(_cmd)];
}
/// 获取移动端登录注册页面logo
+(URLManagerModel *)downloadStationGetLoginRegisterLogImageUrlAppGET{
    return [NSObject url:@"​/downloadStation/getLoginRegisterLogImageUrlApp"
                funcName:NSStringFromSelector(_cmd)];
}
/// 获取金钱符号
+(URLManagerModel *)downloadStationGetMoneySymbolGET{
return [NSObject url:@"​/downloadStation/getMoneySymbol"
            funcName:NSStringFromSelector(_cmd)];
}
/// 推广域名
...
+(URLManagerModel *)downloadStationGetWebsiteIconGET{
    return [NSObject url:@"​/downloadStation​/getWebsiteIcon"
                funcName:NSStringFromSelector(_cmd)];
}
/// 网页版链接
...
+(URLManagerModel *)testSendMqGET{
    return [NSObject url:@"/test/sendMq"
                funcName:NSStringFromSelector(_cmd)];
}
#pragma mark —— 用户中心
/// 银行列表
...
+(URLManagerModel *)chargeOrderChargeOrderListGET{
    return [NSObject url:@"/chargeOrder​/chargeOrderList"
                funcName:NSStringFromSelector(_cmd)];
}
/// 充值订单流水详情
