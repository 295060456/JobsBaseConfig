...
- (void)configCurveView{
    ...
    // _curveView就是r5点
    self.curveX = JobsSCREEN_WIDTH/2.0;       // r5点x坐标
...
- (void)handlePanAction:(UIPanGestureRecognizer *)pan{
    ...
    if(!_isAnimating){
        ...
        if(pan.state == UIGestureRecognizerStateChanged){
            ...
            self.curveX = JobsSCREEN_WIDTH / 2.0 + point.x;
                 ...
                 usingSpringWithDamping:0.5
                  initialSpringVelocity:0
                             ...
                             animations:^{
                                 ...
                                 _curveView.frame = CGRectMake(JobsSCREEN_WIDTH / 2.0, MIN_HEIGHT, 3, 3);
...
- (void)updateShapeLayerPath{
    ...
    [tPath addLineToPoint:CGPointMake(JobsSCREEN_WIDTH, 0)];            // r2点
    
    [tPath addLineToPoint:CGPointMake(JobsSCREEN_WIDTH, MIN_HEIGHT)];  // r4点
