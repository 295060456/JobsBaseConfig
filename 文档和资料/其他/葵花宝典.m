...
-(void)layoutViews {
    self.shareWeb=[[UIWebView alloc]initWithFrame:CGRectMake(0, 0, JobsMainScreen_WIDTH(), JobsMainScreen_HEIGHT())];
    ...
    UIButton *closeBtn=[[UIButton alloc]initWithFrame:CGRectMake(JobsMainScreen_WIDTH()-42, 6, 36, 36)];
